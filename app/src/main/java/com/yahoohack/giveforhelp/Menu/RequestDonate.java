...
public class RequestDonate extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextTotal = (EditText) findViewById(R.id.editTextContact);
    ...
    public void submitPost() {
        ...
        if (TextUtils.isEmpty(total)) {
            Toast.makeText(this, "Please enter total number of item", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        myName.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (name == null) {
                    writeNewPost(getUserMail(), itemName, total, description, timeStamp);
                }
                else {
                    writeNewPost(name, itemName, total, description, timeStamp);
                }
            }
    ...
    public class Post {
        ...
        public Post(String userName, String itemName, String itemTotal, String itemDescription, String keyTimeStamp) {
    ...
    private void writeNewPost(String userId, String itemName, String itemTotal, String itemDescription, String keyTimeStamp) {

        RequestDonate.Post post = new RequestDonate.Post(userId, itemName, itemTotal, itemDescription, keyTimeStamp);
        Map<String, Object> postValues = post.toMap();

        Map<String, Object> childUpdates = new HashMap<>();
        childUpdates.put("/needs/" + timeStamp, postValues);
